...
_LABELMATCHER_TYPE = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name="EQ", index=0, number=0, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="NEQ", index=1, number=1, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="RE", index=2, number=2, serialized_options=None, type=None),
        _descriptor.EnumValueDescriptor(name="NRE", index=3, number=3, serialized_options=None, type=None),
    ],
...
_SAMPLE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="value",
            full_name="prometheus.Sample.value",
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="prometheus.Sample.timestamp",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
...
_TIMESERIES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="labels",
            full_name="prometheus.TimeSeries.labels",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="samples",
            full_name="prometheus.TimeSeries.samples",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_LABEL = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="prometheus.Label.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="prometheus.Label.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_LABELS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="labels",
            full_name="prometheus.Labels.labels",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_LABELMATCHER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="prometheus.LabelMatcher.name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="prometheus.LabelMatcher.value",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_READHINTS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="step_ms",
            full_name="prometheus.ReadHints.step_ms",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="func",
            full_name="prometheus.ReadHints.func",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="start_ms",
            full_name="prometheus.ReadHints.start_ms",
            index=2,
            number=3,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="end_ms",
            full_name="prometheus.ReadHints.end_ms",
            index=3,
            number=4,
            type=3,
            cpp_type=2,
...
Labels = _reflection.GeneratedProtocolMessageType(
    "Labels",
    (_message.Message,),
    dict(
        DESCRIPTOR=_LABELS,
...
LabelMatcher = _reflection.GeneratedProtocolMessageType(
    "LabelMatcher",
    (_message.Message,),
    dict(
...
ReadHints = _reflection.GeneratedProtocolMessageType(
    "ReadHints",
    (_message.Message,),
    dict(
